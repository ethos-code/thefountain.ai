...
export const scenes: Scene[] = [
  ...
  },
  {
    id: 'cycling',
    image: cycling,
    alt: 'First-person view of bicycle handlebars on a wet, neon-lit Tokyo street, with a turn arrow projected onto the stem.',
    label: 'In motion.',
  ...
  },
  {
    id: 'avocado',
    image: avocado,
    alt: 'A hand holding an avocado in a supermarket aisle, with a freshness indicator overlaid on the fruit itself.',
    label: 'In the aisle.',
  ...
  },
  {
    id: 'door',
    image: door,
    alt: 'A wood-paneled front door with a softly projected doorbell button and a clock displaying 7:45 to the right.',
    label: 'At the door.',
